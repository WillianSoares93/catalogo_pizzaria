...
<body>
    ...
    <script>
        ...
        const loadingOverlay = document.getElementById('loading-overlay'); // Referência ao overlay de carregamento
        ...
        function addToOrderOnly(item, clickedButton = null, itemImageUrl = null) {
            ...
            console.log('DEBUG: Ordem e contador atualizados. Itens no carrinho:', order.length); // Log
        }
        ...
        function displayPromotionsPopup() {
            ...
            if (activePromotions.length > 0) {
                activePromotions.forEach(promo => {
                    ...
                    promoDiv.innerHTML = `
                        <h4>${promo.name}</h4>
                        <p>${promo.description || ''}</p> <!-- Adicionado || '' para garantir que não seja 'undefined' -->
        ...
        function addPromotionToOrder(promoId, clickedButton = null, itemImageUrl = null) { 
            ...
            if (promotion) {
                ...
                console.log('DEBUG: Promoção adicionada e UI atualizada.'); // Log
            } else {
        ...
        // Listener para o evento pageshow para recarregar os dados do cardápio quando a página é restaurada do bfcache
        window.addEventListener('pageshow', function(event) {
            // A propriedade event.persisted é true se a página foi restaurada do bfcache
            if (event.persisted) {
                console.log('DEBUG: Página restaurada do bfcache. Recarregando dados do cardápio.');
                loadMenuAndRender();
            }
        });
